...
def main():
    ...
    converter = MD2PDFConverter(
        "action_documentation.md", style="technical", theme="default"
    )
    ...
    converter = MD2PDFConverter(
        ...
        output_file="action_documentation_story_sepia.pdf",
        style="story",
        theme="sepia",
    )
    success = converter.convert()
    ...
    converter = MD2PDFConverter(
        "action_documentation.md",
        output_file="action_documentation_technical_dark.pdf",
        style="technical",
        theme="dark",
    )
    success = converter.convert()
    ...
    converter = MD2PDFConverter(
        "action_documentation.md",
        output_file="action_documentation_whitepaper_oceanic.pdf",
        style="whitepaper",
        theme="oceanic",
    )
    success = converter.convert()
