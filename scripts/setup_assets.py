...
TWEMOJI_ZIP_URL = f"https://github.com/twitter/twemoji/archive/refs/tags/v{TWEMOJI_VERSION}.zip"
...
class AssetSetup:
    ...
    def check_existing_assets(self) -> dict:
        ...
        status = {
            "twemoji": {
                ...
                "count": len(list(self.twemoji_dir.glob("*.svg"))) if self.twemoji_dir.exists() else 0,
    ...
    def download_twemoji_pack(self, force: bool = False) -> bool:
        ...
        try:
            ...
            with zipfile.ZipFile(zip_path, 'r') as zip_ref:
                ...
                svg_files = [f for f in zip_ref.namelist() if f.endswith('.svg') and '/svg/' in f]
                ...
                for svg_file in svg_files:
                    ...
                    if filename:  # Skip directories
                        ...
                        extracted += 1
                        if extracted % 500 == 0:
                            print(f"\r   Extracted: {extracted}/{len(svg_files)} files", end='')
    ...
    def download_minimal_emoji_set(self) -> bool:
        ...
        common_emojis = [
            "1f600", "1f601", "1f602", "1f603", "1f604", "1f605", "1f606", "1f607",  # Smileys
            "1f44d", "1f44e", "1f44f", "1f64f",  # Hands
            "2764", "1f494", "1f495", "1f496", "1f497",  # Hearts
            "1f4a1", "1f4a5", "1f4a9", "1f4af",  # Symbols
            "1f525", "1f4a7", "2b50", "1f31f",  # Nature
            "1f389", "1f38a", "1f388", "1f387",  # Celebration
            "1f4bb", "1f4bc", "1f4bd", "1f4be",  # Tech
            "2705", "274c", "2714", "2716",  # Checkmarks
        ]
        ...
        for emoji_code in common_emojis:
            ...
            try:
                ...
                downloaded += 1
                print(f"\r   Downloaded: {downloaded}/{len(common_emojis)} emojis", end='')
            except Exception as e:
                failed += 1
    ...
    def setup_all(self, minimal: bool = False) -> bool:
        ...
        if success:
            ...
            if final_status["twemoji"]["installed"]:
                ...
                size_mb = sum(f.stat().st_size for f in Path(final_status["twemoji"]["path"]).glob("*.svg")) / (1024*1024)
