...
class BenchmarkSuite:
    ...
    def benchmark_conversion_speed(self):
        ...
        for size, md_file in test_files.items():
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                print(
                    f"    Throughput: {results[size]['throughput_kb_per_sec']:.1f} KB/s"
                )
    ...
    def benchmark_style_loading(self):
        ...
        print(
            f"  CSS generation: {results['css_generation']['mean']*1000:.1f} ms average"
        )
...
"""
    ...
    def generate_report(self):
        ...
        if "conversion_speed" in self.results:
            large_throughput = (
                self.results["conversion_speed"]
                .get("large", {})
                .get("throughput_kb_per_sec", 0)
            )
