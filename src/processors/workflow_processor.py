...
class WorkflowProcessor:
    ...
    def process_files(self, 
                     ...
                     theme: str, 
                     include_header: bool,
                     converter_factory: Callable) -> int:
        ...
        for input_file in markdown_files:
            ...
            converter = converter_factory(str(input_file), str(output_path), style, theme, include_header)
            if converter.convert():
                success_count += 1
                
                # Move original file to processed folder
                processed_path = self.get_unique_filename(input_file, self.processed_folder)
