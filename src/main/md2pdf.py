...
Examples:
  ...
  python md2pdf_refactored.py --style modern --theme elegant  # Process all files in input/
    ...
    if not args.input:
        ...
        success_count = workflow.process_files(args.style, args.theme, include_header, pdf_converter_factory)
        if success_count == 0:
            sys.exit(1)
        return
    ...
    for input_file in input_files:
        ...
        converter = PDFConverter(str(input_file), args.output, args.style, args.theme, include_header)
